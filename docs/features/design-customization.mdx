...
To customize the interface and design of Floorp, go to "Floorp Hub" > click on "Tab & Appearance" in the settings sidebar. At the top, you'll find the "Interface" settings.\
Here, you can change the design to modify the overall appearance of Floorp.

#### Interface Customization Settings
<img src={InterfaceCustomize} width="50%" alt="Interface Customization Settings"/>
...
Custom design by [black7375](https://github.com/black7375). This design was used in Firefox 88.
...
Custom design by [black7375](https://github.com/black7375). This design is an enhanced version of Firefox Proton.
...
Floorp's original design. This design is inspired by Material Design.

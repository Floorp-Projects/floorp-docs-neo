...
description: Learn how to use the mouse gesture feature available in Floorp 12 and later
---
...
Mouse Gestures are disabled by default. You can enable them by navigating to **Floorp Hub > Mouse Gestures**.

By default, basic operations (referred to as "Actions") such as `Back`, `Forward`, and `Reload` are pre-registered.\
...
Since version 12, Floorp-specific settings have been consolidated into the Floorp Hub. You can access it via the application menu, Firefox settings, or by entering `about:hub` in the address bar.

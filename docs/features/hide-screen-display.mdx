...
Break Mode can be enabled via [keyboard shortcuts](/docs/features/shortcuts-and-palette), [mouse gestures](/docs/features/mouse-gestures), and the [command palette](/docs/features/shortcuts-and-palette).

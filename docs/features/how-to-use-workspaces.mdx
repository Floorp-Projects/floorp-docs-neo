...
import ToolBarButton from "@img/features/workspaces-toolbar-button.png";

:::note
This document applies to Floorp version 12 and later. It does not apply to Floorp versions 11 and earlier.
:::

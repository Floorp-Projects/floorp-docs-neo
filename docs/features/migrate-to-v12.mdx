...
Unlike Floop 11's window-specific implementation that resembled tab groups,
...
Not implemented in this release (formerly Browser Manager Sidebar).
...
2 Backup your Floop 11 profile before testing Floop 12

...
If you are already using Floorp 11, installing version 11.30.0 or later will display guidance on the settings page for upgrading to Floorp 12.

<img src={Upgrade} width="50%" alt="Settings page of Floorp 11.30.0"/>

...
In addition to **Menu Bar > Tools**, Zen Mode can also be toggled via [keyboard shortcuts](/docs/features/shortcuts-and-palette), [mouse gestures](/docs/features/gesture), and the [command palette](/docs/features/shortcuts-and-palette).

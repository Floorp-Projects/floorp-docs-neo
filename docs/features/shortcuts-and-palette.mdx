...
The vast majority of actions available for keyboard shortcuts, [mouse gestures](/docs/features/gesture), and the command palette share the same underlying system.

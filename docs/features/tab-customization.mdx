...
- [Interface and Themes](/docs/features/interface-and-themes)
- [Tab Bar Layout](/docs/features/tab-bar-layout)
- [Advanced UI Customization](/docs/features/advanced-ui-customization)
...
You can also switch tabs using [keyboard shortcuts](/docs/features/shortcuts-and-palette), [mouse gestures](/docs/features/mouse-gestures), and the [command palette](/docs/features/shortcuts-and-palette).

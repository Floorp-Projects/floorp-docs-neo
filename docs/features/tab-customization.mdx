...
You can also switch tabs using [keyboard shortcuts](/docs/features/shortcuts-and-palette), [mouse gestures](/docs/features/gesture), or the [command palette](/docs/features/shortcuts-and-palette).

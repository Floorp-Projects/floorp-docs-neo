...
You can also switch tabs using [keyboard shortcuts](/docs/features/shortcuts-and-palette), [mouse gestures](/docs/features/mouse-gestures), or the [command palette](/docs/features/shortcuts-and-palette).

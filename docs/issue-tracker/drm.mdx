...
Floorp does not have a Widevine license. Therefore, DRM-protected videos or music cannot be played in Floorp.

### Why Floorp Doesn't Have a License

Acquiring a license requires Floorp developers to pay at least $5,000 to DRM providers.

Floorp is developed by a community of mainly Japanese software developers. This issue will not be resolved as the community is not commercially oriented.

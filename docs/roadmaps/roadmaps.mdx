...
:::info
This roadmap represents our development plans and may be subject to change based on circumstances.
For the latest information, please check our [official website](https://floorp.app) and [official blog](https://blog.floorp.app).
:::
...
- Opt-in AI features utilizing local LLM
- Implementation of desktop application integration features
- Publication of detailed specifications blog

### Addition of New Update Channel "Beta"
- Provision of more stable versions than Daylight channel
- Enabling gradual feature releases

## 2025 Q3

### Floorp OS (AI Integration) Beta Release
- Start of experimental feature provision
...
- Implementation of content protection technology

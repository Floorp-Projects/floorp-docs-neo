---
title: The Floorp Team and Project
---
...
The Floorp Projects consists of the Floorp team and contributors.

- **Admins** are members who manage the Floorp Projects and mainly decide its direction.
- **Moderators (Floorp Team)** are members who manage the project and community. Admins are also part of the moderators.
...
For inquiries about the Floorp Projects or to report vulnerabilities in the Floorp Browser, please contact the following members.
...
- [**Ryosuke Asano (@Ryosuke-Asano)**](https://github.com/Ryosuke-Asano)
  ...
  - [r.asano@floorp.app](mailto:r.asano@floorp.app)

- [**Lapis (@Walkmana-25)**](https://github.com/Walkmana-25)
  - One of the community admins. Working on Floorp 13.
  - [y.takahashi@floorp.app](mailto:y.takahashi@floorp.app)
...
- [**Cutter (@CutterKnife)**](https://github.com/CutterKnife)
  ...
  - [cutter@floorp.app](mailto:cutter@floorp.app)
